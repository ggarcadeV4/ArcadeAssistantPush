...
def _get_drive_root() -> Path:
    return Path(os.getenv("AA_DRIVE_ROOT", r"A:\\"))
...
class ScoreService:
    ...
    def reset_score(self, rom_name: str) -> dict:
        """
        ...
        hi_file = get_hiscore_dir() / f"{rom_name}.hi"
        ...
        if hi_file.exists():
            try:
                ...
                target_backup_dir = get_backup_dir() / rom_name
        ...
        result["ai_state_cleared"] = self._clear_json_entry(rom_name)
    ...
    def _clear_json_entry(self, rom_name: str) -> bool:
        """
