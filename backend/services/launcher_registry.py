...
_register_adapter('dolphin', 'backend.services.adapters.dolphin_adapter', enabled=True)      # Always: Wii + GameCube -> Dolphin Joystick
...
_register_adapter('supermodel', 'backend.services.adapters.supermodel_adapter', enabled=True) # Always: Sega Model 3 -> Supermodel standalone
...
_register_adapter('ppsspp', 'backend.services.adapters.ppsspp_adapter', enabled=True)         # Always: Sony PSP -> Standalone PPSSPP
