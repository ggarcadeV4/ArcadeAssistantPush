...
DEFAULTS = {
    ...
    # Voice / TTS (Phase 3)
    "elevenlabs_api_key": None,                    # set in .env or config.json
    "tts_enabled":        True,                    # master switch for TTS
    "default_voice_id":   "pNInz6obpgDQGcFmaJgB",  # Adam — clear, warm default
...
def load_config() -> dict:
    ...
    # ElevenLabs: fall back to env var if not in config file
